        ...
        <div class="form-group">
            ...
            <select class="form-control" id="ID_tipo" name="ID_tipo" required>
                ...
                <optgroup label="Herramientas" style="font-weight: bold; color: black;">
                    <option value="1" {{ $producto->ID_tipo == 1 || $producto->ID_tipo == 2 ? 'selected' : '' }}>Herramientas Manuales</option>
                    <option value="2" {{ $producto->ID_tipo == 1 || $producto->ID_tipo == 2 ? 'selected' : '' }}>Herramientas Eléctricas</option>
                </optgroup>
                <optgroup label="Materiales" style="font-weight: bold; color: black;">
                    <option value="3" {{ $producto->ID_tipo == 3 || $producto->ID_tipo == 4 ? 'selected' : '' }}>Materiales Básicos</option>
                    <option value="4" {{ $producto->ID_tipo == 3 || $producto->ID_tipo == 4 ? 'selected' : '' }}>Acabados</option>
                </optgroup>
                <optgroup label="Equipos" style="font-weight: bold; color: black;">
                    <option value="5" {{ $producto->ID_tipo == 5 || $producto->ID_tipo == 6 ? 'selected' : '' }}>Equipos de Seguridad</option>
                    <option value="6" {{ $producto->ID_tipo == 5 || $producto->ID_tipo == 6 ? 'selected' : '' }}>Accesorios Varios</option>
                </optgroup>
            </select>
        </div>
