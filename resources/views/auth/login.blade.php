                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <p class="small mb-0">Bienvenidos a Ferremas, su distribuidora de confianza para todos los productos de ferretería y construcción. Fundada en la comuna de Santiago en la década de los 80, FerreMas ha crecido de manera constante, estableciéndose como un referente en la región metropolitana y más allá. Contamos con 4 sucursales en la región metropolitana y 3 en otras regiones del país, con planes de seguir expandiéndonos para llegar a cada rincón de Chile.</p>
                                </div>
                            </div>
                        </div>
                    </div>
